...
class Bottleneck(nn.Module):
    def __init__(self, in_channel, out_channel, expansion, activation, stride=1, padding=1):
        ...
        self.conv2 = nn.Conv1d(in_channel * expansion, in_channel * expansion, kernel_size=3,
...
class EffNet(nn.Module):
    ...
    def __init__(self, num_additional_features=0, depth=[1, 2, 2, 3, 3, 3, 3],
        ...
        self.stage2 = MBConv(channels[0], channels[1], expansion, depth[0],
                             stride=2)  # 16 #input, output, depth # 3 conv
